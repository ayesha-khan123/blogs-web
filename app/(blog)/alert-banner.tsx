    ...
    >
      <div className="py-2 text-center text-sm">
        {pending ? (
          ...
          <>
          <ul className="flex space-x-3 justify-end align-middle mr-3">
          <li>{"Blogs"}</li>
          <li> {"About"}</li> 
          <li>{"News"}</li> 
          <li>{"Contact Us"}</li> 
...
//         <div>
//               <div>
//     <header className='flex shadow-md py-4 px-4 sm:px-10 bg-blue-800 text-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
...
//            className='hover:text-[#007bff] text-[#dde3e9] block font-semibold text-[15px]'>Home</a>
//        </li>
//        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
//          className='hover:text-[#007bff] text-[#dde3e9] block font-semibold text-[15px]'>Blogs</a>
//        </li>
//        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
//          className='hover:text-[#007bff] text-[#dde3e9] block font-semibold text-[15px]'>About</a>
//        </li>
//        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
//          className='hover:text-[#007bff] text-[#dde3e9] block font-semibold text-[15px]'>Contact</a>
//        </li>
//      </ul>
//    </div>
...
//      <button
//        className='px-4 py-2 text-sm rounded-full font-bold text-white border-2 border-[#007bff] bg-[#007bff] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#fdfeff]'>Sign
//        up</button>
